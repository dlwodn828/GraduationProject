        ...
        <!-- <h4 class="card-title mb-4 mt-1">Login</h4> -->
            ...
            <input type="hidden" name="<?=$this->security->get_csrf_token_name()?>" value="<?=$this->security->get_csrf_hash()?>" />
                ...
                <div class="form-group">
                    ...
                    <input id="AdminId" name="AdminId" value="<?=$AdminId?>" class="form-control" placeholder="ID" type="id">
                </div> <!-- form-group// -->
                ...
                <div class="form-group"> 
                    ...
                    <a href="/main/join" class="float-right btn btn-outline-primary">Sign up</a>
                </div> <!-- form-group// -->  
                <div class="form-group">
